...
def transform_trip(trip):
    ...
    for alternative in trip['alternatives']:
        ...
        example_new_format[request_id][offer_id].setdefault('duration', GetTime_format(tdelta.total_seconds()))
        #num_legs = 0
        ...
        for segment in alternative['segments']:
            for leg in segment['legs']:
                ...
                example_new_format[request_id][offer_id][leg_id].setdefault('duration', GetTime_format(tdelta.total_seconds()))
                #transportation mode
                ...
                example_new_format[request_id][offer_id][leg_id].setdefault('leg_stops',MultiPoint([coord_ini,coord_fin]))
